      ...
      <Box
          ...
          <SimpleGrid columns={{ base: 1, sm: 2, md: 4 }} spacing={8}>
            ...
            <Stack align={'flex-start'}>
                ...
                <Flex align='center' justify='center' gap={2}>
                    <EmailIcon fontSize={19}/> <Text fontSize='16px'>comunicacao.segef@ananindeua.pa.gov.br</Text>
                </Flex>
            </Stack>
          </SimpleGrid>
          <Flex justify='space-between' align='center'>
            <Image
                src="img/logo_branca_300.png"
                alt='logo'
                boxSize={{base:'10rem', md:'20rem'}}
                objectFit='contain'/>
                <Image
                src="img/background-rodape.png"
                alt='logo'
            ...
            <Flex direction='column'>
                <Heading as='h2'  size='xl'>Sede</Heading>
                <Text><Link href='https://www.google.com/maps/place/SEGEF+%7C+Zona+Norte/@-1.3523748,-48.3773397,17z/data=!3m1!4b1!4m6!3m5!1s0x92a45fbe5953ae91:0x6f561ccf6dcbc897!8m2!3d-1.3523748!4d-48.375151!16s%2Fg%2F11b7hm6b22' target='_blank'>Cláudio Sanders, 1590 - Maguari, Ananindeua - PA</Link></Text>
                <Text>Horário de Atendimento: 08h às 14h</Text>
            </Flex>
            <Flex direction='column'>
            <Heading as='h2'  size='xl'>SAC - ANANINDEUA - 1° piso</Heading>
                <Text><Link href='https://www.google.com/maps/place/Shopping+Metr%C3%B3pole+Ananindeua/@-1.3843123,-48.4190674,16z/data=!4m10!1m2!2m1!1sshopping+metr%C3%B3pole!3m6!1s0x92a48add49248045:0xe31a062559d9a546!8m2!3d-1.3841694!4d-48.4098321!15sChNzaG9wcGluZyBtZXRyw7Nwb2xlWhUiE3Nob3BwaW5nIG1ldHLDs3BvbGWSAQ9zaG9wcGluZ19jZW50ZXKaASRDaGREU1VoTk1HOW5TMFZKUTBGblNVUkNiVGhoV21oUlJSQULgAQA!16s%2Fg%2F11bzwm7w24' target='_blank'>Rodovia BR 316, nº 4.500, Km 04 - Coqueiro, Ananindeua - PA</Link></Text>
                <Text>Horário de Atendimento: 08h às 14h</Text>
            </Flex>
            </Stack>
        </Container>
        <Box py={10}>
          ...
          <Text pt={6} fontSize={'sm'} textAlign={'center'}>
            © 2023 SEGEF. Todos direitos reservados
          </Text>
        </Box>
      </Box>
    );
